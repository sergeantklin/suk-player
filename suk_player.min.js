...
function Recorder(e){function n(e){q.gain.value=e?1:0}function t(e){Z=e,o()}function o(){U&&(U&&U.disconnect(),T&&T.disconnect(),G&&G.disconnect(),x&&x.disconnect(),A&&A.disconnect(),O&&O.disconnect(),D&&D.disconnect(),q&&q.disconnect(),e.filters[e.filters.length-1].disconnect(),D.gain.value=_*Z,G.gain.value=(1-_)*Z,U.connect(D),D.connect(x),x.connect(q),q.connect(M.destination))}function r(){d()}function i(e){e=e||{audio:!0,video:!0},navigator.getUserMedia(e,function(n){if(E=n,F=e,e.video){var t=document.querySelector("#capturingVideo");t.volume=0,t.src=window.URL.createObjectURL(n)}U=M.createMediaStreamSource(E),o()},function(){})}function c(){return C&&C.getBlob()||null}function u(){return C&&C.getBlob()||null}function a(){h=!0,C||(C=new MRecordRTC(E)),C.bufferSize=1024,C.sampleRate=8e3,C.numberOfAudioChannels=1,C.startRecording()}function d(){U.disconnect(),A.disconnect(),O&&O.disconnect(),E&&(E.stop(),E=null)}function s(n){if(h&&!n){var t=e.onStopRecord;console.log("YOU CHOOSE STOP RECORD")}A.stopRecord(),h=!1,C?C.stopRecording(function(e,n){t&&t(e,n)}):(O.stopRecord(),t&&t())}function f(e){return A.trimBuffer(e)}function l(e,n){function t(){b=L.attachSoundTouch({tempo:1,pitch:1,soundBuffer:o,position:e}),b.connect(M.destination),n()}var o=A.getBuffer();if(C){var r=document.querySelector("#capturedVideo");r.autoplay=!1;var i=function(){r.play(),t()};r.oncanplay=i,r.volume=0,r.src=C.toURL(),r.currentTime=e*o.duration}else t()}function p(){if(b&&b.disconnect(),C){var e=document.querySelector("#capturedVideo");e.pause()}}function v(e){_=e,o()}function g(e){I=e,o()}function R(){var e=new XMLHttpRequest;e.open("GET","reverb.wav",!0),e.responseType="arraybuffer",e.onload=function(n){M.decodeAudioData(e.response,function(e){T.buffer=e})},e.send()}function m(n,t){for(var o=n,r=0,i=o.length;i>r;r++)e.filters[r].gain.value=o[r]}function y(){return A.getBuffer()}function S(){return O.getBuffer()}function B(){requestAnimationFrame(B),E&&0!=q.gain.value&&(x.getByteFrequencyData(V),e.onRecordLevel(V))}var E,C,U,b,h,F,M=e.audioContext,w=e.BUFFER_SIZE,A=new RecordingAudioNode({audioContext:M,BUFFER_SIZE:w,onRecordLevel:e.onRecordLevel,mono:!0,supressRecord:!0}),O=new RecordingAudioNode({audioContext:M,BUFFER_SIZE:w,mono:!0}),L=new PitchPlayer({audioContext:M,BUFFER_SIZE:w}),T=M.createConvolver(),G=M.createGain(),q=M.createGain(),x=M.createAnalyser(),V=new Uint8Array(10),I=!0,Z=1,_=.3,D=M.createGain();return Storage.AudioContextConstructor=M,navigator.getUserMedia||e.onGetUserMediaError&&e.onGetUserMediaError(),R(),B(),{startRecord:a,startCapture:i,stopRecord:s,stopCapture:r,replay:l,getVideo:u,getBlobs:c,getBuffer:y,getOriginalBuffer:S,trimBuffer:f,setMicLevel:t,setReverbGain:v,stopReplay:p,setReverbConvolver:g,setFilter:m,setOutput:n}}"undefined"==typeof MediaStream||"stop"in MediaStream.prototype||(MediaStream.prototype.stop=function(){this.getAudioTracks().forEach(function(e){e.stop()}),this.getVideoTracks().forEach(function(e){e.stop()})});
