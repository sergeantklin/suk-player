...
function RecordingAudioNode(e){function n(e){var n=e.inputBuffer.getChannelData(0),t=e.outputBuffer.getChannelData(0);if(h.mono)var r=n,o=t;else var r=e.inputBuffer.getChannelData(1),o=e.outputBuffer.getChannelData(1);for(var a=-(1/0),u=0;u<n.length;u++)a=Math.max(a,n[u],r[u]),c&&!h.supressRecord&&(v.push(n[u]),h.mono||B.push(r[u])),t[u]=n[u],o[u]=r[u];h.onRecordLevel&&h.onRecordLevel(a)}function t(e){if(e){for(var n=(e-v.length,[]),t=[],r=v,o=0,a=r.length;a>o;o++)console.log(r[o]),n.push(r[o]),t.push(B[o]);v=n,rightChannel=t}}function r(){v=[],B=[],i=null,c=!0}function o(){c&&(i=u(),l=i.duration),c=!1}function a(){return l}function u(){function e(e,t){for(var r=n.getChannelData(t),o=e,a=0,u=o.length;u>a;a++)r[a]=o[a]}if(i)return i;if(!v.length)return{length:0,duration:0};var n=g.createBuffer(p,v.length,g.sampleRate);return e(v,0),h.mono||e(B,1),B=[],v=[],n}function f(){return v.length}console.error(1);var c,i,l,h=e||{},g=h.audioContext,s=h.BUFFER_SIZE,p=h.mono?1:2,d=g.createScriptProcessor?g.createScriptProcessor(s,p,p):g.createJavaScriptNode(s,p,p),v=[],B=[];return d.trimBuffer=t,d.onaudioprocess=n,d.startRecord=r,d.stopRecord=o,d.getBuffer=u,d.getDuration=a,d.getLength=f,d}
function Recorder(e){function t(e){x.gain.value=e?1:0}function o(e){V=e,n()}function n(){C&&(C&&C.disconnect(),G&&G.disconnect(),L&&L.disconnect(),w&&w.disconnect(),O&&O.disconnect(),I&&I.disconnect(),x&&x.disconnect(),e.filters[e.filters.length-1].disconnect(),C.connect(b.destination))}function r(){d()}function c(e){e=e||{audio:!0,video:!0},navigator.getUserMedia(e,function(t){if(E=t,h=e.video){var o=document.querySelector("#capturingVideo");o.volume=0,o.src=window.URL.createObjectURL(t)}C=b.createMediaStreamSource(E)},function(){})}function i(){return y&&y.getBlob()||null}function u(){return y&&y.getBlob()||null}function a(){M=!0,h?(y&&y.clearRecordedData,y=new MRecordRTC(E),y.startRecording()):O.startRecord()}function d(){C.disconnect(),w.disconnect(),O&&O.disconnect(),E&&(E.stop(),E=null)}function s(t){if(M&&!t){var o=e.onStopRecord;console.log("YOU CHOOSE STOP RECORD")}w.stopRecord(),M=!1,y?y.stopRecording(function(e,t){o&&o(e,t)}):(O.stopRecord(),o&&o())}function f(e){return w.trimBuffer(e)}function l(e,t){function o(){U=T.attachSoundTouch({tempo:1,pitch:1,soundBuffer:n,position:e}),U.connect(b.destination),t()}var n=w.getBuffer();if(y){var r=document.querySelector("#capturedVideo");r.autoplay=!1;var c=function(){r.play(),o()};r.oncanplay=c,r.volume=0,r.src=y.toURL(),r.currentTime=e*n.duration}else o()}function p(){if(U&&U.disconnect(),y){var e=document.querySelector("#capturedVideo");e.pause()}}function R(e){q=e,n()}function v(e){A=e,n()}function g(){var e=new XMLHttpRequest;e.open("GET","reverb.wav",!0),e.responseType="arraybuffer",e.onload=function(t){b.decodeAudioData(e.response,function(e){G.buffer=e})},e.send()}function S(t,o){for(var n=t,r=0,c=n.length;c>r;r++)e.filters[r].gain.value=n[r]}function m(){return w.getBuffer()}function B(){return O.getBuffer()}var E,y,C,U,M,h,b=e.audioContext,F=e.BUFFER_SIZE,w=new RecordingAudioNode({audioContext:b,BUFFER_SIZE:F,onRecordLevel:e.onRecordLevel,mono:!0,supressRecord:!0}),O=new RecordingAudioNode({audioContext:b,BUFFER_SIZE:F,mono:!0}),T=new PitchPlayer({audioContext:b,BUFFER_SIZE:F}),G=b.createConvolver(),L=b.createGain(),x=b.createGain(),A=!0,V=1,q=.3,I=b.createGain();return Storage.AudioContextConstructor=b,navigator.getUserMedia||e.onGetUserMediaError&&e.onGetUserMediaError(),g(),{startRecord:a,startCapture:c,stopRecord:s,stopCapture:r,replay:l,getVideo:u,getBlobs:i,getBuffer:m,getOriginalBuffer:B,trimBuffer:f,setMicLevel:o,setReverbGain:R,stopReplay:p,setReverbConvolver:v,setFilter:S,setOutput:t}}"undefined"==typeof MediaStream||"stop"in MediaStream.prototype||(MediaStream.prototype.stop=function(){this.getAudioTracks().forEach(function(e){e.stop()}),this.getVideoTracks().forEach(function(e){e.stop()})});
