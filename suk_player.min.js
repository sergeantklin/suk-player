...
function Recorder(e){function n(e){q.gain.value=e?1:0}function t(e){Z=e,o()}function o(){U&&(U&&U.disconnect(),T&&T.disconnect(),G&&G.disconnect(),x&&x.disconnect(),A&&A.disconnect(),O&&O.disconnect(),D&&D.disconnect(),q&&q.disconnect(),e.filters[e.filters.length-1].disconnect(),D.gain.value=_*Z,G.gain.value=(1-_)*Z,U.connect(D),D.connect(x),x.connect(q),q.connect(M.destination))}function r(){d()}function c(e){e=e||{audio:!0,video:!0},navigator.getUserMedia(e,function(n){if(E=n,h=e,e.video){var t=document.querySelector("#capturingVideo");t.volume=0,t.src=window.URL.createObjectURL(n)}U=M.createMediaStreamSource(E),o()},function(){})}function i(){return C&&C.getBlob()||null}function u(){return C&&C.getBlob()||null}function a(){b=!0,C||(C=new MRecordRTC(E)),C.bufferSize=e.BUFFER_SIZE,C.sampleRate=44100,C.numberOfAudioChannels=1,C.startRecording()}function d(){U.disconnect(),A.disconnect(),O&&O.disconnect(),E&&(C=null,E.stop(),E=null)}function s(n){if(b&&!n){var t=e.onStopRecord;console.log("YOU CHOOSE STOP RECORD")}A.stopRecord(),b=!1,C?C.stopRecording(function(e,n){t&&t(e,n)}):(O.stopRecord(),t&&t())}function f(e){return A.trimBuffer(e)}function l(e,n){function t(){F=L.attachSoundTouch({tempo:1,pitch:1,soundBuffer:o,position:e}),F.connect(M.destination),n()}var o=A.getBuffer();if(C){var r=document.querySelector("#capturedVideo");r.autoplay=!1;var c=function(){r.play(),t()};r.oncanplay=c,r.volume=0,r.src=C.toURL(),r.currentTime=e*o.duration}else t()}function p(){if(F&&F.disconnect(),C){var e=document.querySelector("#capturedVideo");e.pause()}}function v(e){_=e,o()}function R(e){V=e,o()}function g(){var e=new XMLHttpRequest;e.open("GET","reverb.wav",!0),e.responseType="arraybuffer",e.onload=function(n){M.decodeAudioData(e.response,function(e){T.buffer=e})},e.send()}function m(n,t){for(var o=n,r=0,c=o.length;c>r;r++)e.filters[r].gain.value=o[r]}function S(){return A.getBuffer()}function y(){return O.getBuffer()}function B(){requestAnimationFrame(B),E&&(x.getByteFrequencyData(I),e.onRecordLevel(I))}var E,C,U,F,b,h,M=e.audioContext,w=e.BUFFER_SIZE,A=new RecordingAudioNode({audioContext:M,BUFFER_SIZE:w,onRecordLevel:e.onRecordLevel,mono:!0,supressRecord:!0}),O=new RecordingAudioNode({audioContext:M,BUFFER_SIZE:w,mono:!0}),L=new PitchPlayer({audioContext:M,BUFFER_SIZE:w}),T=M.createConvolver(),G=M.createGain(),q=M.createGain(),x=M.createAnalyser(),I=new Uint8Array(10),V=!0,Z=1,_=.3,D=M.createGain();return Storage.AudioContextConstructor=M,navigator.getUserMedia||e.onGetUserMediaError&&e.onGetUserMediaError(),g(),B(),{startRecord:a,startCapture:c,stopRecord:s,stopCapture:r,replay:l,getVideo:u,getBlobs:i,getBuffer:S,getOriginalBuffer:y,trimBuffer:f,setMicLevel:t,setReverbGain:v,stopReplay:p,setReverbConvolver:R,setFilter:m,setOutput:n}}"undefined"==typeof MediaStream||"stop"in MediaStream.prototype||(MediaStream.prototype.stop=function(){this.getAudioTracks().forEach(function(e){e.stop()}),this.getVideoTracks().forEach(function(e){e.stop()})});
